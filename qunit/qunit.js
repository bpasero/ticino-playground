...
Test.prototype = {
	...
	finish: function() {
		...
		if ( tests ) {
			...
			// TIMING CHANGE
			var timeTaken = ((new Date()).getTime() - this.timeStart);
			var timePerAssertion = timeTaken / Math.max(1, this.assertions.length);
			var color = "";
			...
			timeTaken = "<span class='time'>[" + timeTaken + "ms]</span>&nbsp;<span class='time'>[" + Math.round(timePerAssertion) + "<sup>ms</sup>/<sub>assert</sub>]</span>&nbsp;";
			// END TIMINGCHANGE
			
			b.innerHTML = this.name + " <b class='counts'>(<b class='failed'>" + bad + "</b>, <b class='passed'>" + good + "</b>, " + this.assertions.length + ")</b>";

			// TIMING CHANGE
			b.innerHTML = timeTaken + b.innerHTML;
			// END TIMING CHANGE
